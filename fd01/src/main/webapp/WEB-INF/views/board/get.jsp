...
<script>
	...
	replyService.getList({
		...
		for (var i = 0, len = list.length || 0; i < len; i++) {
			console.log("replyservice.getList의 list안에 데이터 집어넣는 로직 ")
			console.log(list[i]);
		}
	});
			...
			.ready(
					function() {
						...
						function showList(page) {
							console.log("showList함수에 접근했습니다 :" + page);

							// `page`가 1보다 작은 경우 1로 설정
							// page = page < 1 ? 1 : page;
							...
							replyService.getList(
											...
											function(replyCnt, list) {
												...
												console.log("replyService.getList함수에 접근했습니다 ")
